...
int main()
{
	...
	SpriterEngine::SpriterModel scmlModel("Release/GreyGuy/player.scml", new SpriterEngine::ExampleFileFactory(&window), new SpriterEngine::ExampleObjectFactory(&window));
